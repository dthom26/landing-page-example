    ...
    <Section id="how-to-use">
      <div className="max-w-[77.5rem] mx-auto px-5 md:px-10 lg:px-15 xl:max-w-[87.5rem]">
        ...
        <div className="relative">
          {/* Left Section */}
          <div className="relative z-1 flex items-center h-[39rem] mb-5 border border-[#FFFFFF]/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
                  ...
                  {brainwaveServicesIcons.map((item, index) => (
                    <li
                      className={`rounded-2xl flex items-center justify-center ${
                        index === 2
                          ? "w-[3rem] h-[3rem] p-0.25 bg-[conic-gradient(from_225deg,#FFC876,#79FFF7,#9F53FF,#FF98E2,#FFC876)] md:w-[4.5rem] md:h-[4.5rem]"
