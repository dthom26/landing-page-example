        ...
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6.25rem]">
          <h1 className="font-semibold text-[2.5rem] leading-[3.25rem] md:text-[2.75rem] md:leading-[3.75rem] lg:text-[3.25rem] lg:leading-[4.0625rem] xl:text-[3.75rem] xl:leading-[4.5rem] mb-6">
            ...
            <span className="inline-block relative">
              ...
              <img
                src={curve}
                className="absolute top-full left-0 w-full xl:-mt2"
                width={624}
                height={28}
                alt="Curve"
              />
        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          ...
          >
            <div className="relative bg-[#0E0C15] rounded-[1rem]">
              <div className="h-[1.4rem] bg-[#43435C] rounded-t-[0.8rem]" />
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                <Generating className="absolute left-4 right-4 bottom-5 md:left-1/2 md:row-auto md:bottom-8 md:w-[31rem] md:-translate-x-1/2" />
