  ...
  return (
    <div
      ...
      className={`
        ...
        ${
          customPaddings ||
          `py-10 lg:py-16 xl:py-29 ${crosses ? "lg:py-32 xl:py-40" : ""}`
        }
          ${className || ""}`}
    >
      {children}
      ...
      <div className="hidden absolute top-0 right-5-5 w-0.25 h-full bg-[#26242C] pointer-events-none md:block lg:right-7.5 xl:right-10" />
      {crosses && (
        <>
          <div
